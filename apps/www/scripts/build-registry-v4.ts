...
`
  ...
  // Write style block.
  rimraf.sync(path.join(ROOT_PATH, '__registry__/block.ts'))
  await writeFile(path.join(ROOT_PATH, '__registry__/block.ts'), index)
}
...
`
  ...
  // Write style index.
  rimraf.sync(path.join(ROOT_PATH, '__registry__/icons.ts'))
  await writeFile(
    path.join(ROOT_PATH, '__registry__/icons.ts'),
    index,
  )
}
